<%-- 
    Document   : index
    Created on : 27-Jun-2023, 12:19:06 am
    Author     : amitpatnaik
		...
		<div id="bg_img">
			<div id="site_div">
				...
				<div id="header">
					...
					<div id="menu">
						<ul>
							<li><a href="#">Home</a></li>							<li><a href="post.jsp">Post Status</a></li>
					...
					%>
								...
								%>
									...
									<form id="form1" method="post" action="loginprocess.jsp">
										<fieldset>
											User Name:<input id="text1" type="text" name="username" /><br/>
											Password:<input id="text2" type="password" name="userpass" /><br/>
											<input type="submit" id="login-submit" value="Login"/>
											<div class="foot_pad">
							<ul class="ls">
								<li><a href="register.jsp">New User</a></li>
							<li><a href="forgot.jsp">Forgot Password</a></li>	<li><a href="admin.jsp">Administrator Login</a></li></ul></div>
										</fieldset>
									</form>
								</div>
							</div>
